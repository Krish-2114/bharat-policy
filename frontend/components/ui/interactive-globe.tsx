...
const DEFAULT_MARKERS = [
  { lat: 28.61, lng: 77.20, label: "New Delhi" },
  ...
  { lat: 18.52, lng: 73.85, label: "Pune" },
  { lat: 23.02, lng: 72.57, label: "Ahmedabad" },
  { lat: 26.91, lng: 75.78, label: "Jaipur" },
  { lat: 21.17, lng: 72.83, label: "Surat" },
];

const DEFAULT_CONNECTIONS: { from: [number, number]; to: [number, number] }[] =
  [
    { from: [28.61, 77.20], to: [19.07, 72.87] }, // Delhi to Mumbai
    { from: [28.61, 77.20], to: [12.97, 77.59] }, // Delhi to Bengaluru
    { from: [19.07, 72.87], to: [13.08, 80.27] }, // Mumbai to Chennai
    { from: [22.57, 88.36], to: [17.38, 78.48] }, // Kolkata to Hyderabad
    { from: [12.97, 77.59], to: [13.08, 80.27] }, // Bengaluru to Chennai
    { from: [19.07, 72.87], to: [18.52, 73.85] }, // Mumbai to Pune
    { from: [28.61, 77.20], to: [26.91, 75.78] }, // Delhi to Jaipur
    { from: [19.07, 72.87], to: [23.02, 72.57] }, // Mumbai to Ahmedabad
    { from: [17.38, 78.48], to: [12.97, 77.59] }, // Hyderabad to Bengaluru
    { from: [22.57, 88.36], to: [28.61, 77.20] }, // Kolkata to Delhi
  ];
